...
communication: 아래 패턴 중 하나라도 해당되면 communication으로 분류
  ...
  - 업무 메일·메시지 작성 요청 (예: "메일 써줘", "이메일 작성해줘", "메시지 써줘", "메일 초안 써줘", "초안 작성해줘", "연차 신청 메일 써줘", "재택근무 신청 메일 써줘", "재택근무 신청하고 싶은데 메일 써줘", "경비 정산 메일 써줘", "사직서 메일 써줘")
  ⚠️ "재택근무 신청 메일 써줘", "연차 메일 초안 써줘"처럼 신청·보고 관련 메일 작성 요청은 rag가 아닌 반드시 communication으로 분류 (재택근무 조건 자체를 물어보는 것과 다름)

...
rag          : 회사 규정·문서·복지·IT 환경·법률·주차·시설 질문 (기본값, 노동법·근로기준법 포함)
  예) "A4 용지는 어디 있어요?", "Slack에서 확인했다는 표시는 어떻게 해요?", "소프트웨어 설치하고 싶은데 어떻게 해요?", "주차 어디서 해요?", "주차비 얼마예요?", "주차장 어디 있어요?", "입사 첫날 점심은 어떻게 하나요?", "첫날 점심은 어떻게 해요?", "헬스케어 앱 구독 지원해줘", "건강관리 앱 구독료 지원받을 수 있어요?", "임직원 의료비 지원 어떻게 돼?"
...
_OUT_OF_SCOPE_EXTERNAL_MESSAGE = (
    "저는 회사 규정·복지·IT 환경 전문 버디라서 그 부분은 도움드리기 어려워요. 😅 "
    "그런 건 팀 동료분들이 훨씬 잘 알고 계실 거예요!\n\n"
    "사내 규정·복지·IT 환경 관련 궁금한 건 언제든 물어봐 주세요. 제가 제일 잘하는 영역이거든요!"
)

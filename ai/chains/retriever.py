...
_QUERY_EXPANSIONS: list[tuple[str, str]] = [
    ...
    ("식대", "식대 지원 식사비 중식비 밥값"),
    ("밥값", "식대 식대 지원 식사비 중식비"),
    ("점심", "식대 식대 지원 점심 식대 중식비 복지카드 첫날 점심"),
    ("중식", "점심 식대 점심시간 복지카드 식대 지원"),
    ("밥", "식대 식대 지원 식사비 중식비 복지카드"),
    ("식사", "식대 식대 지원 복지카드 식사비 점심"),
    ("저녁", "야근 식대 석식 저녁 식대 지원 초과근무"),
    ("저녁식사", "야근 식대 석식 저녁 식대 지원"),
    ("저녁밥", "야근 식대 석식 저녁 식대 지원"),
    ("석식", "야근 식대 저녁 식사 저녁 식대 지원 초과근무"),
    ...
    ("나와", "지원 있어 가능 제공 됩니다"),
    ("병원", "조퇴 반차 병가 외출 의료비 건강관리"),
    ("병원가", "조퇴 반차 병가 외출"),
    ("병원 가", "조퇴 반차 병가 외출"),
    ("급여명세서", "급여명세 급여 확인 월급명세서 임금명세서 급여 메뉴"),
    ("임금명세서", "급여명세서 급여 확인 월급명세서 급여 메뉴"),
    ("영수증", "영수증 제출 정산 불필요 복지카드 식대"),

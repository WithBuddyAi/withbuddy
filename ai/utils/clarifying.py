...
- "경비 정산은 어떻게 해요?" → 경비 정산 방법으로 명확
- "비품은 어떻게 신청해요?" → 비품 신청 방법으로 명확
- "복지카드로 쓸 수 없는 항목이 뭐예요?" → 복지카드 제한 항목으로 명확
- "탕비실에서 뭘 무료로 이용할 수 있어요?" → 탕비실 혜택으로 명확
- "생일에 뭔가 혜택이 있나요?" → 생일 혜택으로 명확
- "출퇴근 기록은 어떻게 해요?" → 출퇴근 기록 방법으로 명확
- "점심 식대 영수증 제출해야 하나요?" → 식대 영수증 여부로 명확
- "야근 식대랑 회식비는 뭐가 달라요?" → 두 항목 차이점으로 명확
- "출퇴근 기록은 어떻게 해요?" → 출퇴근 기록 방법으로 명확
- "점심 식대 영수증 제출해야 하나요?" → 식대 영수증 여부로 명확
- "야근 식대랑 회식비는 뭐가 달라요?" → 두 항목 차이점으로 명확
- "복지카드로 쓸 수 없는 항목이 뭐예요?" → 복지카드 제한 항목으로 명확
...
- "비품은 어떻게 신청해요?" → 비품 신청 방법으로 명확
- "경비 정산은 어떻게 해요?" → 경비 정산 방법으로 명확
- "수습 기간이 얼마나 돼요?" → 수습 기간으로 명확
- "연차는 언제부터 생겨요?" → 연차 발생 시점으로 명확
- "법인카드 사용 후 어떻게 처리해요?" → 법인카드 처리 방법으로 명확
- "복지카드는 언제부터 쓸 수 있어요?" → 복지카드 시작 시점으로 명확
- "소프트웨어 설치하고 싶은데 어떻게 해요?" → 소프트웨어 설치 방법으로 명확
- "연차나 급여, 증명서 관련 문의는 누구에게 하나요?" → 담당자 질문으로 명확
- "온라인 강의 지원은 어떻게 돼요?" → 강의 지원 안내로 명확
- "VPN은 언제 써야 해요?" → VPN 사용 시점으로 명확
- "연차 신청은 Flex에서 해요, Notion에서 해요?" → 사용 도구 선택으로 명확
- "출근 시간이 어떻게 되고 비품 신청은 어떻게 해요?" → 두 항목 각각 명확
- "급여일이 언제고 건강검진은 언제부터 받을 수 있어요?" → 두 항목 각각 명확
- "육아휴직은 얼마나 쓸 수 있어요?" → 육아휴직 기간으로 명확
- "수습 기간이 얼마고 복지카드는 언제부터 쓸 수 있어요?" → 두 항목 각각 명확
...
3. 선택지는 회사 사규·복지 문서에 실제로 명시될 법한 항목만 포함하세요. 카페테리아·구내식당·셔틀버스 등 특수 시설은 문서에 없을 가능성이 높으므로 제외하세요.
4. 절차·담당자·기한 등 회사별로 달라지는 정보는 포함하지 않음
5. 1~3문장 이내, 간결하게
6. "어떤 부분이 궁금하신가요?"로 끝내는 것을 권장

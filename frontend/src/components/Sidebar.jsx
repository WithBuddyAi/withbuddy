          ...
          <div className="px-[16px] py-[24px]">
            <div className="text-[#336B97] gap-[4px] mb-[8px] px-[8px]">
              ...
              <p className="text-[#868E96] text-[12px]">
                날짜를 선택하면 해당 날짜의 대화 내용을 확인할 수 있습니다.
              </p>
            </div>
              ...
              <Calendar
                ...
                tileContent={({ date }) => {
                  ...
                  if (activeDates.includes(formatted)) {
                    return (
                      <div className="absolute bottom-[3px] flex justify-center w-[full]">
        ...
        <div className="hidden md:flex relative z-10 w-[76px] flex-col mt-[32px]">
          ...
          <div className="py-[24px] px-[16px]">
            <NavLink
              ...
              className={({
                isActive,
              }) => `flex items-center justify-center py-[10px] px-[12px] rounded-[6px] border-[1px] w-[44px] h-[48px] hover:bg-[#D0EBFFCC] hover:border-[#D0EBFF] text-[#336B97] text-[16px]
                ${isActive ? "bg-[#EAF6FF] border-[#4791CA]" : "bg-[#FFFFFF] border-[#D0EBFF]"}`}
            >
              <MessageSquare size={14} />
            </NavLink>

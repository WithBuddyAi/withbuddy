    ...
    <div className='h-screen bg-[#FFFFFF] flex flex-col'>
      <div className='flex-1 flex flex-col items-center justify-center lg:flex-row lg:gap-[64px]'>
        ...
        lg:flex-col lg:mr-[340px] lg:items-center'>
          <img className='w-[35px] h-[35px] mr-[17px] 
          md:w-[38px] md:h-[38px] md:mr-[26px] 
          lg:w-[138px] lg:h-[120px] lg:mb-[30px] lg:mr-0' 
          src={char} alt="위드버디 캐릭터"/>
          <img className='w-[215px] h-[48px] 
          lg:w-[291px] lg:h-[69px]' 
          src={withbuddy} alt="위드버디 로고"/>
        </div>
        ...
        <form onSubmit={(e) => {
          ...
          <div className='flex flex-col items-center gap-5'>
            ...
            <div className='flex flex-col items-center gap-[10px] rounded-[8px]'>
              ...
              {companyCodeError && <div className='text-[#F03E3E] text-[10px] w-[297px] md:text-[12px] md:w-[430px]'>{companyCodeError}</div>}
            </div>
            ...
            <div className='flex flex-col items-center gap-[10px] rounded-[8px]'>
              ...
              {employeeNumberError && <div className='text-[#F03E3E] text-[10px] w-[297px] md:text-[12px] md:w-[430px]'>{employeeNumberError}</div>}
            </div>
            
            {/* 이름 입력칸 */}
            <div className='flex flex-col items-center gap-[10px] rounded-[8px]'>
              <div className='font-bold text-[14px] w-[297px] md:text-[16px] md:w-[430px]'>이름
                <span className='text-red-500'>*</span></div>
              <input 
              ...
              {errorMessage && <div className='text-[#F03E3E] text-[10px] w-[297px] mt-[5px] md:text-[12px] md:w-[430px] md:mt-[10px]'>{errorMessage}</div>}
      ...
      <footer className='text-[10px] text-[#6A7282] text-center pb-6 md:text-[12px]'>© 2026 WithBuddy. A Builders League Project.</footer>
    </div>
  )
}
